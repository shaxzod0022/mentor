...
export default function DeleteSubmissionModal({ isOpen, studentName, loading, onClose, onConfirm }) {
      ...
      <div className="relative bg-white w-full max-w-md rounded-3xl shadow-2xl border border-slate-100 overflow-hidden animate-in zoom-in-95 duration-300">
        <div className="p-8 text-center space-y-4">
          ...
          <div className="space-y-2">
            <h2 className="text-xl font-bold text-slate-900">Vazifani o'chirishni tasdiqlaysizmi?</h2>
            <p className="text-slate-500 text-sm leading-relaxed">
              Siz haqiqatdan ham <span className="font-bold text-slate-900">"{studentName}"</span>ning ushbu vazifasini o'chirib tashlamoqchimisiz? Bu amalni ortga qaytarib bo'lmaydi.
            </p>
          </div>

...
import { X, User, Mail, Lock, Shield, UserPlus, AlertCircle, CheckCircle2 } from 'lucide-react';
...
export default function AddUserModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.message || 'Foydalanuvchi yaratishda xatolik yuz berdi');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="relative bg-white w-full max-w-xl rounded-[2.5rem] shadow-2xl border border-slate-100 overflow-hidden animate-in zoom-in-95 duration-300">
        <div className="p-8 pb-4 flex items-center justify-between border-b border-slate-50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900">Yangi foydalanuvchi</h2>

...
export default function DeleteConfirmModal({ isOpen, onClose, onConfirm, userName, loading }) {
    ...
    <div className="fixed inset-0 z-60 flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="relative bg-white w-full max-w-md rounded-[2.5rem] shadow-2xl border border-slate-100 overflow-hidden animate-in zoom-in-95 duration-300">
        <div className="p-8 pb-0 flex flex-col items-center text-center">
          ...
          <h2 className="text-xl font-bold text-slate-900 mb-2">Foydalanuvchini o'chirish</h2>
          <p className="text-slate-500 text-sm leading-relaxed px-4">
            Haqiqatdan ham <span className="font-bold text-slate-900">"{userName}"</span> foydalanuvchisini tizimdan butunlay o'chirib yubormoqchimisiz?
          </p>
          <div className="mt-4 p-3 bg-rose-50/50 rounded-xl border border-rose-100/50">
            <p className="text-[10px] font-bold text-rose-600 uppercase tracking-widest">Diqqat: Ushbu amalni ortga qaytarib bo'lmaydi!</p>
          </div>
        </div>

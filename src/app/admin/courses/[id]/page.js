    ...
    try {
      const updatedAssignments = {
        teachers:
          activeTab === "teachers"
            ? userIds
            : course.teachers.map((u) => u._id),
        mentors:
          activeTab === "mentors" ? userIds : course.mentors.map((u) => u._id),
        students:
          activeTab === "students"
            ? userIds
            : course.students.map((u) => u._id),
      };
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm">
            Kurs materiallari va foydalanuvchilarini boshqarish
          </p>
        </div>
      </div>
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`px-2 py-0.5 rounded-lg text-[10px] ${activeTab === tab.id ? "bg-white/20" : "bg-slate-100 text-slate-400"}`}
                  >
                    {tab.count}
                  </span>
                </button>
            ...
            <div className="p-8 border-b border-slate-50 flex items-center justify-between">
              ...
              {activeTab === "materials" ? (
                ...
                !(
                  ...
                  (isMentor &&
                    (activeTab === "teachers" || activeTab === "mentors"))
                ) && (
                  <button
              ...
              {activeTab === "materials" ? (
                materials.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {materials.map((material) => (
                      <div
                        key={material._id}
                        className="p-6 rounded-3xl border border-slate-50 bg-slate-50/50 hover:bg-white hover:border-indigo-100 transition-all group relative"
                      >
                ...
                submissions.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {submissions.map((sub) => (
                      <div
                        key={sub._id}
                        className="p-6 rounded-3xl border border-slate-50 bg-slate-50/50 hover:bg-white hover:border-indigo-100 transition-all group"
                      >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {currentUsers.map((user) => (
                    <div
                      key={user._id}
                      className="flex items-center justify-between p-4 rounded-3xl border border-slate-50 bg-slate-50/50 hover:bg-white hover:border-indigo-100 transition-all group"
                    >
                      <div className="flex items-center gap-3">
